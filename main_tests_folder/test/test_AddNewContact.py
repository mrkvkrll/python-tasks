...
def test_add_new_contact(app):
    ...
    app.contact.filling_out_contact_forms(Contact(name="petr", middle_name="petrovich", last_name="petrov", nickname="ptr", company="yandex", address="minin strasse", home="587676586896",
